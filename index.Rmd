...
## Definição
Um modeloo estatístico formal é definido pela trinca $(\mathcal{X},\mathcal{F},\mathcal{P})$, em que:  
...
Os dois últimos resultados mostram que o teste proposto é fortemente consistente para a interseção e para a união quando $I = \{1,2\}$ (dois conjuntos).
