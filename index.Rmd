...
Sejam $\Theta_1, \Theta_2 \subseteq \Theta$ conjuntos *disjuntos*, $\alpha_1 = \alpha_2 = 0.05$,
- $\mathbb{P}(\Theta_1) = 0.04$
- $\mathbb{P}(\Theta_2) = 0.03$

Neste caso, $\Theta_1 \in \mathcal{R}_{0.05}^{\boldsymbol{x}_n}$ e $\Theta_2 \in \mathcal{R}_{0.05}^{\boldsymbol{x}_n}$. No entanto,
...
Sejam $\Theta_1, \Theta_2 \subseteq \Theta$ conjuntos *independentes*, $\alpha_1 = \alpha_2 = 0.05$,
- $\mathbb{P}(\Theta_1) = 0.96$
- $\mathbb{P}(\Theta_2) = 0.96$

Neste caso, $\Theta_1 \in \mathcal{A}_{0.05}^{\boldsymbol{x}_n}$ e $\Theta_2 \in \mathcal{A}_{0.05}^{\boldsymbol{x}_n}$. No entanto,
$$\mathbb{P}(\Theta_1 \cap \Theta_2) = \mathbb{P}(\Theta_1) \mathbb{P}(\Theta_2) = 0.9216,$$
portanto, $\Theta_1 \cap \Theta_2 \notin \mathcal{A}_{0.05}^{\boldsymbol{x}_n}$. É possível aceitar separadamente as hipóteses $\boldsymbol{\theta} \in \Theta_1$ e $\boldsymbol{\theta} \in \Theta_2$, mas não a hipótese $\boldsymbol{\theta} \in \Theta_1 \cap \Theta_2$.
